 ...
 * 线路3
 */
public class PlayerViewLine3 extends RelativeLayout implements GestureDetector.OnGestureListener {
...
//    private RelativeLayout mRootLayout;
    ...
    public PlayerViewLine3(Context context) {
        super(context);
        initView(context);
    }

    public PlayerViewLine3(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public PlayerViewLine3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.player_view_line3_steam_layout, this);
        //初始化控件
        initControlView();
