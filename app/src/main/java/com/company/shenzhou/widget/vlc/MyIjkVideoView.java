 ...
 * Describe
 */
public class MyIjkVideoView extends RelativeLayout implements GestureDetector.OnGestureListener {
    ...
    private void initView(Context context) {
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.ijk_video_layout, this);
        //初始化控件
        initControlView();
