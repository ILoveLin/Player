 ...
 */
public final class CommonAddUpdateDeviceDialog {

    @SuppressWarnings("unchecked")
    public static class Builder<B extends CommonAddUpdateDeviceDialog.Builder<?>>
        ...
        public Builder(Context context) {
            super(context);
            setContentView(R.layout.ui_add_update_device_dialog);
