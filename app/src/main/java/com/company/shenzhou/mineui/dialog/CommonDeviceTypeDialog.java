 ...
 */
public final class CommonDeviceTypeDialog {

    @SuppressWarnings("unchecked")
    public static class Builder<B extends CommonDeviceTypeDialog.Builder<?>>
        ...
        public Builder(Context context) {
            super(context);
            setContentView(R.layout.ui_device_type_dialog);
