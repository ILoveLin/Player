...
//        super.onCreate();
//        LogUtils.e("NotificationService===onCreate");
...
//    //渠道名
//    private String CHANNEL_NAME = "CME Mic";
//    //通知管理者
...
//        Intent intent = null;
//        if (mChannel.equals(Constants.PLAYER_CHANNEL2)) {//Channel==1:  p2p Nginx
//            //RC200默认 22
...
//            }
//        } else if (mChannel.equals(Constants.PLAYER_CHANNEL1)) {//Channel==0:http 转播
//            //RC200默认 22
//            if ("22".equals(isRC200)) {
//                intent = new Intent(this, IjkPlayerRC200Activity.class);
//            } else {
...
//
//            }
//        } else if (mChannel.equals(Constants.PLAYER_CHANNEL3)) {//Channel==2:腾讯云
//            intent = new Intent(this, TencentLine3SDKActivity.class);
//        }
//        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0,
//                intent, 0);
//        int flagOngoingEvent = Notification.FLAG_ONGOING_EVENT;
//
//        Uri defaultUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
//            //(1)8.0以上初始化通知
//            this.mChannel = new NotificationChannel(CHANNEL_ID,
//                    CHANNEL_NAME, NotificationManager.IMPORTANCE_HIGH);//NotificationManager.IMPORTANCE_HIGH 渠道重要级
//            this.mChannel.enableLights(true);
//            this.mChannel.setLightColor(Color.RED);
//            this.mChannel.setShowBadge(true);
//            this.mChannel.setLockscreenVisibility(Notification.VISIBILITY_PUBLIC);
...
//                    .setContentTitle(getString(R.string.notification_call))
//                    .setContentText(getString(R.string.notification_call_online))
//                    .setOngoing(true)//设置为ture，表示它为一个正在进行的通知。他们通常是用来表示 一个后台任务,用户积极参与(如播放音乐)或以某种方式正在等待
